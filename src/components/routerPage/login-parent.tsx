        ...
        <div className="d-flex justify-content-center align-items-center w-100 vh-100 bg-dk-blue login-parent">
            <div>
                ...
                <div className="pt-4 pb-2 font-12 text-light text">
                    Bạn gặp vấn đề với tài khoản đăng nhập? Vui lòng liên hệ
                    với trung tâm ILA gần nhất theo liên kết bên dưới để được
                    hỗ trợ / Any issues? Please contact your friendly
                    centre support at below link
                </div>
                <div className="py-2">
                    <a href="font-12 ">
